...
const Comprehensive = () => {
  return (
    <Container>
      <View style={{ marginTop: 12, flex: 1, marginHorizontal: 6 }}>
        <MasonryFlashList
          data={photoData}
          numColumns={2}
...
const Photography = () => {
  return (
    ...
    >
      <SubMenuTab.Screen name="综合" component={Comprehensive} />
      <SubMenuTab.Screen name="最热" component={Hottest} />
      <SubMenuTab.Screen name="最新" component={Newest} />
    </SubMenuTab.Navigator>
  );
};
